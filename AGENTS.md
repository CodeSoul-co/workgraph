...
- Build concrete experiment workflows, experiment MAS implementations, experiment configs, and evaluation scripts in this repository. Implement reusable MAS support or Hypha framework capabilities, such as a message bus, runtime communication abstractions, event contracts, or core adapters, in the Hypha core checkout instead.
